...
Testie.test("PiecingItTogether") { |do, skip|
  ...
  skip.test("square puzzle with 32 rows") {
  ...
  skip.test("400 pieces square puzzle with only inside pieces and aspect ratio") {
  ...
  skip.test("1500 pieces landscape puzzle with 30 rows and 1.6 aspect ratio") {
  ...
  skip.test("300 pieces portrait puzzle with 70 border pieces") {
  ...
  skip.test("puzzle with insufficient data") {
  ...
  skip.test("puzzle with contradictory data") {
