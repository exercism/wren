...
Testie.test("Roman Numerals") { |do, skip|
  ...
  skip.test("converts 16") { Expect.value(Number.toRoman(16)).toEqual("XVI") }
  ...
  skip.test("converts 66") { Expect.value(Number.toRoman(66)).toEqual("LXVI") }
  ...
  skip.test("converts 166") { Expect.value(Number.toRoman(166)).toEqual("CLXVI") }
  ...
  skip.test("converts 666") { Expect.value(Number.toRoman(666)).toEqual("DCLXVI") }
  skip.test("converts 911") { Expect.value(Number.toRoman(911)).toEqual("CMXI") }
  skip.test("converts 1666") { Expect.value(Number.toRoman(1666)).toEqual("MDCLXVI") }
