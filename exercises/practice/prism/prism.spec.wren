import "./prism" for Prism
import "wren-testie/testie" for Testie, Expect

Testie.test("Prism") { |do, skip|
  do.test("zero prisms") {
    var start = { "x": 0, "y": 0, "angle": 0 }
    var prisms = []
    var expected = []
    Expect.value(Prism.findSequence(prisms, start)).toEqual(expected)
  }

  skip.test("one prism one hit") {
    var start = { "x": 0, "y": 0, "angle": 0 }
    var prisms = [
  ...
  skip.test("going up zero hits") {
    var start = { "x": 0, "y": 0, "angle": 90 }
    var prisms = [
  ...
  skip.test("going down zero hits") {
    var start = { "x": 0, "y": 0, "angle": -90 }
    var prisms = [
      { "id": 1, "x": 10, "y": 0, "angle": 0 },
  ...
  skip.test("going left zero hits") {
    var start = { "x": 0, "y": 0, "angle": 180 }
    var prisms = [
      { "id": 2, "x": 0, "y": 10, "angle": 0 },
      { "id": 3, "x": 10, "y": 0, "angle": 0 },
  ...
  skip.test("large angle") {
    var start = { "x": 0, "y": 0, "angle": 2340 }
    var prisms = [
      { "id": 1, "x": 10, "y": 0, "angle": 0 }
    ]
    var expected = []
  ...
  skip.test("upward refraction two hits") {
    var start = { "x": 0, "y": 0, "angle": 0 }
    var prisms = [
  ...
  skip.test("downward refraction two hits") {
    var start = { "x": 0, "y": 0, "angle": 0 }
    var prisms = [
  ...
  skip.test("multiple prisms floating point precision") {
    var start = { "x": 0, "y": 0, "angle": -6.429 }
    var prisms = [
    ...
    var expected = [
      7, 30, 16, 28, 13, 22, 23, 10,
      9, 24, 25, 38, 29, 4, 35, 21,
      5, 20, 11, 1, 33, 26, 32, 6,
      15, 17, 2, 14, 27, 34, 37, 31,
      36, 18, 19, 8, 3, 12
    ]
    Expect.value(Prism.findSequence(prisms, start)).toEqual(expected)
  }

  skip.test("complex path with multiple prisms floating point precision") {
    var start = { "x": 0, "y": 0, "angle": 0.0 }
    var prisms = [
    ...
    var expected = [
      43, 44, 66, 45, 52, 35, 49, 13,
      3, 69, 46, 28, 20, 11, 24, 38,
      19, 42, 15, 10, 63, 25, 59, 1,
      6, 2, 4, 67, 22, 29, 65, 64,
      12, 47, 54, 68, 23, 75, 8, 26,
      18, 9, 60, 17, 31, 7, 70, 40,
      5, 51, 61, 55, 57, 14, 58, 76,
      56, 16, 21, 30, 73, 62, 74, 41,
      39, 36, 50, 37, 33, 71, 72, 34,
      32, 27, 48, 53
    ]
    Expect.value(Prism.findSequence(prisms, start)).toEqual(expected)
  }
